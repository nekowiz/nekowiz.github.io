...
// For updating evo materials dymanically.
lastProp = "";
evo_id   = [];
...
function getCardDataDone(data) {
	...
	for (var i = 1; i <= 8; i++) {
		$("#evo_"+i).change(function() {
			...
			// Keep the recodes of the Regular Evo Materials (for updating evo materials dymanically).
...
/**
 * Dymanically Update the Evo Material Option when changing the Prop, inputting the Special Evo Material.
