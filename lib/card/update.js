...
function getCardDataDone(data) {
	...
	// 產生編輯表單
	var table_elem = $("<table class='article-table'><tr><th>卡片 小圖示</th><td class='card_small'></td></tr><tr><th>卡片 ID</th><td>" + card_data["id"] + "</td></tr></table>");
