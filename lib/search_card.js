...
function add_card(card_id) {
	...
	// small_picture
	last_tr.append("<td rowspan='2'><a href='javascript:false;' onclick='remove_card(this);'></a></td>");
...
function save_to_browser() {
	var card_list = {};
	$("#evo_list tr[data-card_id]").each(function (record,recordnumber) {
		card_list[record.data("card_id")] = 1;
	});
	localStorage.setItem("card_list", JSON.stringify(card_list));
}

function load_from_browser() {
	$("#evo_list re[data-card_id]").remove();
