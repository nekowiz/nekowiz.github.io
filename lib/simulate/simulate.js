(function() {
  ...
  Card = (function() {
      ...
      $.ajax({
        ...
        success: (function(_this) {
          return function(data) {
            var line, store_data, _i, _len, _ref;
            ...
            if (_this.ss_cd === "") {
              ...
              _this.ss_cd = parseInt(_this.ss_cd, 10);
            }
            _this.current_cd = _this.ss_cd;
            _this.max_hp = parseInt(_this.max_hp, 10);
            _this.max_atk = parseInt(_this.max_atk, 10);
            _this.cost = parseInt(_this.cost, 10);
            _this.current_hp = _this.max_hp;
            _this.max_level = parseInt(_this.max_level, 10);
            _this.as_data = {};
            _this.ss_data = {};
            $.ajax({
    ...
    Card.prototype.one_turn_pass = function() {
      if (!this.is_dead() && this.current_cd > 0) {
        return this.current_cd -= 1;
      }
    };
      ...
      if (this.current_cd === 0) {
        switch (this.ss_data.type) {
          ...
          case "傷害減輕型":
            break;
          case "攻擊回合延遲型":
            for (_o = 0, _len6 = current_enemies.length; _o < _len6; _o++) {
              enemy = current_enemies[_o];
  ...
  load_card_info_to_input = function() {
    var atk_index, cd_index, hp_index, i, id_index, name_index, _i, _results;
    _results = [];
    for (i = _i = 1; _i <= 6; i = ++_i) {
      hp_index = "#card" + i + "_hp";
      ...
      _results.push($(cd_index).val(cards[i - 1].current_cd));
    }
    return _results;
  };
  ...
  attack_penal = function(prop) {
    var as_enable, card, index, tmp, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
    combo += 1;
    disable_attacks();
