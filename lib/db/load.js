		...
		if (question == "") {
			...
			var db_result = taffy_dbs["normal"]( function () {
				for (var question_index in question_split) {
					...
					if (this.question.toLowerCase().search(question_key) == -1) return false;
				}
				return true;
			});
			var search_result_html = "<table class='article-table'><tr><th>題號</th><th>類型</th><th>難度</th><th>題目</th><th>答案</th><th></th></tr>";
