	...
	$.ajax({
		...
		for (var question_index in data_arr) {
			...
			if (question_id != q_id) {
				...
				// 產生編輯表單
				var result_html = "題目類型：<select class='gen'><option>生活常識</option><option>動漫與遊戲</option><option>文科</option><option>理科</option><option>演藝</option><option>體育</option><option>&lt;待填&gt;</option></select><hr />題目難度：<select class='color'><option>1色</option><option>2色</option><option>3色</option><option>&lt;待填&gt;</option></select><hr /><input type='text' class='problem' placeholder='題目內容' size='100' /><hr /><input type='text' class='answer' placeholder='答案' size='30' /><hr /><button class='cancel_edit'>取消修改</button>&nbsp;<button class='confirm_edit'>確認修改</button>";
	...
	$.ajax({
		...
		for (var question_index in data_arr) {
			...
			if (question_id != q_id) {
				...
				// 產生編輯表單
				var result_html = "<input type='text' class='problem' placeholder='題目內容' size='100' /><hr /><input type='text' class='answer1' placeholder='順位1' size='30' /><hr /><input type='text' class='answer2' placeholder='順位2' size='30' /><hr /><input type='text' class='answer3' placeholder='順位3' size='30' /><hr /><input type='text' class='answer4' placeholder='順位4' size='30' /><hr /><button class='cancel_edit'>取消修改</button>&nbsp;<button class='confirm_edit'>確認修改</button>";
				$(".questFinder .edit").html(result_html).show(1000);
				$(".questFinder .problem").val(question_text);
	...
	$.ajax({
		...
		for (var question_index in data_arr) {
			...
			if (question_id != q_id) {
				...
				// 產生編輯表單
				var result_html = "<input type='text' class='problem' placeholder='題目內容' size='100' /><hr /><input type='text' class='answer' placeholder='答案' size='30' /><hr /><button class='cancel_edit'>取消修改</button>&nbsp;<button class='confirm_edit'>確認修改</button>";
				$(".questFinder .edit").html(result_html).show(1000);
				$(".questFinder .problem").val(question_text);
				$(".questFinder .answer").val(question_answer);
				// 取得圖片 img
